...
Este proyecto fue desarrollado para demostrar el impacto de la campaña de vacunación en Chile mediante visualización de datos oficiales.

### Metodología Ética
- ✅ Uso exclusivo de datos oficiales gubernamentales
- ✅ Transparencia total en procesamiento y correcciones
- ✅ Preservación de la integridad de datos históricos
- ✅ Documentación completa de todas las modificaciones

## 📞 Contacto y Referencias

**Datos oficiales**:
- MinCiencia Chile: https://github.com/MinCiencia/Datos-COVID19
- Ministerio de Salud (MINSAL): https://www.minsal.cl/
- DEIS: https://informesdeis.minsal.cl/

**Fuentes de validación**:
- OPS/OMS: Evaluación de la efectividad de la vacuna contra la COVID-19 en Chile, 2021
- The successful COVID-19 vaccine rollout in Chile: Factors and challenges (PMC)
